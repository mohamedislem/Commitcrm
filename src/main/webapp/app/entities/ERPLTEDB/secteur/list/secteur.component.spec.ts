...
describe('Secteur Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'secteur', component: SecteurComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.secteurs?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to secteurService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getSecteurIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSecteurIdentifier).toHaveBeenCalledWith(entity);
