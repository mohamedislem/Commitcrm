...
import { EntityArrayResponseType, SecteurService } from '../service/secteur.service';
...
export class SecteurComponent implements OnInit {
  ...
  trackId = (_index: number, item: ISecteur): string => this.secteurService.getSecteurIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.secteurs = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISecteur[] | null): ISecteur[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.secteurService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
