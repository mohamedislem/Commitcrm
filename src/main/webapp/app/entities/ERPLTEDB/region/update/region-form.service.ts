...
type RegionFormGroupContent = {
  ...
  gouvernorat: FormControl<IRegion['gouvernorat']>;
  societe: FormControl<IRegion['societe']>;
};
...
export class RegionFormService {
  createRegionFormGroup(region: RegionFormGroupInput = { id: null }): RegionFormGroup {
    ...
    return new FormGroup<RegionFormGroupContent>({
      ...
      gouvernorat: new FormControl(regionRawValue.gouvernorat),
      societe: new FormControl(regionRawValue.societe),
    });
  }
