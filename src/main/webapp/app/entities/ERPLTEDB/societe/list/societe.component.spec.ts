...
describe('Societe Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'societe', component: SocieteComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.societes?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
