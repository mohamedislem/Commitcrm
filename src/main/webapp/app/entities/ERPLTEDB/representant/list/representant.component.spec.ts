...
describe('Representant Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'representant', component: RepresentantComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.representants?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to representantService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getRepresentantIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRepresentantIdentifier).toHaveBeenCalledWith(entity);
