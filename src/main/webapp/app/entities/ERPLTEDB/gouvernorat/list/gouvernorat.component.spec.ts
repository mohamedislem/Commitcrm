...
describe('Gouvernorat Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'gouvernorat', component: GouvernoratComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.gouvernorats?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to gouvernoratService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getGouvernoratIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getGouvernoratIdentifier).toHaveBeenCalledWith(entity);
